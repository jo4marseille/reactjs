...
function FinalCard() {
  return (
        <div className='my-containt'>
          ...
          <Card style={{backgroundColor:  '#fff', marginBottom: '70px', height: '700px', border: "solid #00A651 12px" , borderRadius: "100px 0px", boxShadow: "0 3px 10px #000000a6", overflow: 'hidden'}}
            className="text-center">
